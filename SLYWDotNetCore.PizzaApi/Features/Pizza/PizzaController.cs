...
using SLYWDotNetCore.PizzaApi.Db;
using SLYWDotNetCore.PizzaApi.Features.Queries;
using SLYWDotNetCore.Shared;

namespace SLYWDotNetCore.PizzaApi.Features.Pizza
{
    ...
    public class PizzaController : ControllerBase
    {
        ...
        public IActionResult GetOrder(string invoiceNo)
        {
            ...
            var modal = new PizzaOrderInvoiceResponse
            {
                Order = item,
                OrderDetail = lst
            };
